...
public class RingView extends View {
    ...
    public RingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        initPaint();
        //初始化半径值
        outRadius = Util.dp2px(context, 50);
        inRadius = Util.dp2px(context, 40);
        ringRadius = Util.dp2px(context, 68);
        //外圆变大的变化值
        outChange = Util.dp2px(context, 20);
        //内圆变小的变化值
        inChange = Util.dp2px(context, 10);
        //外边环的宽度
        widthRing = Util.dp2px(context, 4);
